            ...
            <div className="lg:hidden mt-4">
              <div className="bg-white/90 backdrop-blur-xl rounded-2xl p-4 border border-amber-200/50 shadow-xl">
                <div className="space-y-2">
                  ...
                  <a href="/priprava" className="block px-4 py-3 text-amber-800 font-bold bg-amber-100 rounded-xl">Příprava</a>
                  <div className="space-y-1">
                    <p className="px-4 py-2 text-amber-800 font-semibold text-sm">Svátosti</p>
                    <a href="/krest" className="block px-6 py-2 text-amber-700 hover:bg-amber-100 rounded-xl transition-colors duration-300">Křest</a>
                    ...
                    <a href="/eucharistie" className="block px-6 py-2 text-amber-700 hover:bg-amber-100 rounded-xl transition-colors duration-300">Eucharistie</a>
                  </div>
