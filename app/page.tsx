        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-6">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center space-x-1">
              <Link href="/"
                 className="group relative px-4 xl:px-6 py-3 text-amber-800 font-bold text-base xl:text-lg transition-all duration-300 bg-amber-100 rounded-2xl"><span className="relative z-10">Úvod</span>
              </Link>
              <Link 
                href="/priprava"
            ...
            <div className="lg:hidden mt-4">
              <div className="bg-white/90 backdrop-blur-xl rounded-2xl p-4 border border-amber-200/50 shadow-xl">
                <div className="space-y-2">
                  <Link  href="/" className="block px-4 py-3 text-amber-800 font-bold bg-amber-100 rounded-xl">Úvod</Link>
                  ...
                  <div className="space-y-1">
                    ...
                    <Link  href="/krest" className="block px-6 py-2 text-blue-700 hover:bg-amber-100 rounded-xl transition-colors duration-300">Křest</Link>
                    ...
                    <Link  href="/eucharistie" className="block px-6 py-2 text-red-700 hover:bg-amber-100 rounded-xl transition-colors duration-300">Eucharistie</Link>
                  </div>
